...
export const HomePage = () => {
  ...
  return (
    ...
    <div className="card" style={getState.mode === "light" ? { left: "0", right: "0", margin: "auto", padding: "20px" }: { backgroundColor: "#303335", color: "#d2d3db", left: "0", right: "0", margin: "auto", padding: "20px", height: "86vh" }}>
